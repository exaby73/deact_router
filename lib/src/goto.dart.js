...
(function dartProgram() {
  ...
  N = {
    main() {
      var next,
        t1 = type$.Location,
        search = t1._as(window.location).search;
      if (search == null)
        search = "";
      next = "next=" + H.S(t1._as(window.location).pathname);
      if (search.length === 0)
        t1._as(window.location).href = "/?" + next;
      else
        t1._as(window.location).href = "/" + search + "&" + next;
    }
  },
  P = {
  ...
  (function inheritance() {
    ...
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, W.DomException, W.Location]);
    ...
    _inheritMany(H.Closure, [H.Closure2Args, H.TearOffClosure, H.initHooks_closure, H.initHooks_closure1]);
    _inheritMany(H.TearOffClosure, [H.StaticClosure, H.BoundClosure]);
    _inherit(H.initHooks_closure0, H.Closure2Args);
...
;
  ...
  (function nativeSupport() {
    ...
    hunkHelpers.setOrUpdateInterceptorsByTag({ApplicationCacheErrorEvent: J.Interceptor, DOMError: J.Interceptor, ErrorEvent: J.Interceptor, Event: J.Interceptor, InputEvent: J.Interceptor, SubmitEvent: J.Interceptor, EventTarget: J.Interceptor, MediaError: J.Interceptor, NavigatorUserMediaError: J.Interceptor, OverconstrainedError: J.Interceptor, PositionError: J.Interceptor, GeolocationPositionError: J.Interceptor, SensorErrorEvent: J.Interceptor, SpeechRecognitionError: J.Interceptor, Window: J.Interceptor, DOMWindow: J.Interceptor, SQLError: J.Interceptor, DOMException: W.DomException, Location: W.Location});
...
//# sourceMappingURL=goto.dart.js.map
